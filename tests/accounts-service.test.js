...
import { firstAccount, secondAccount, thirdAccount, fourthAccount } from "./data/accounts.js";
...
describe("AccountsService: listAccounts()", () => {
  ...
  it("should return all accounts of the first page", async () => {
    const accounts = await accountsService.listAccounts({ accessToken: "access_token" });
  ...
  it("should return all accounts of the first page", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", fetchAll: true });
  ...
  it("should throw an error if accessToken is not provided", async () => {
    await expect(accountsService.listAccounts()).rejects.toThrow("Required access token is missing");
  });
  ...
  it("should return list of 3 accounts when limit is equal to 3", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", limit: 3 });
  ...
  it("shoudl handle pagination when after parameter is provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", after: "next_uri" });
  ...
  it("should handle limit when limit parameter is provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", limit: 1 });
  ...
  it("should handle limit and pagination when limit and after parameters are provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", after: "next_uri", limit: 1 });
  ...
  it("should return all the accounts if limit is greater than number of accounts", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", limit: 10 });
  ...
  it("should return all the accounts if after parameter doesn't exist", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", after: "invalid_uri" });
  ...
  it("should return corresponding account when valid itemId parameter is provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", itemId: 123456 });
  ...
  it("should return an empty array if there are no corresponding accounts to a provided itemId", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", itemId: 654321 });
  ...
  it("should return corresponding account when limit and itemId parameters are provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", limit: 1, itemId: 123456 });
  ...
  it("should return corresponding account when limit and itemId and after parameters are provided", async () => {
    ...
    const accounts = await accountsService.listAccounts({ accessToken: "access_token", limit: 1, itemId: 123456, after: "next_uri" });
